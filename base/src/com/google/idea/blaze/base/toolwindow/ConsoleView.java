 ...
 * (which can be deleted after the new tool-window is release).
 *
 * <p>The class handles how the output of a single task is displayed int the tool-window.
 */
public final class ConsoleView implements Disposable {
  ...
  private JComponent createContent() {
    ...
    Content console =
        layoutUi.createContent(
            TasksToolWindowFactory.ID, consoleView.getComponent(), "", null, null);
